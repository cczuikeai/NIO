    ...
    public Server() {
        try {
            /*
                ...
                端口建立连接
                如果端口被当前操作系统中其他程序使用了,那么这里实例化会抛出异常:
...
//                        if (allOut[i] == pw) {//比较的是地址,所有不用考虑位置在哪
